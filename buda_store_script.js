(function () {
    ...
    modalContainer.innerHTML = '<div class="q-card-ia">'
        ...
        + '</div>'
        + '</div>'
        + '<a href="https://provoulevou.com.br/?utm_source=widget&utm_medium=parceiro&utm_campaign=buda" target="_blank" rel="dofollow noopener" style="display:flex;align-items:center;gap:5px;text-decoration:none;justify-content:center;padding:15px;background:#000;flex-shrink:0;"><span style="font-size:11px;color:#94a3b8;">powered by</span><img src="https://provoulevou.com.br/assets/provoulevou-logo.png" style="height:14px;filter:brightness(0) invert(1);"></a>'
        + '</div>';
    ...
    function initProvadorTools() {
        ...
        function validateForm() {
            ...
            var isPhoneValid = isValidBRPhone(phone);
