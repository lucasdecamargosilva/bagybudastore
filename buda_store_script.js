(function () {
    ...
    modalContainer.innerHTML = '<div class="q-card-ia">'
        ...
        + '</div>'
        + '</div>'
        + '<div class="q-powered-footer"><span style="font-size:11px;color:#999;">powered by</span><img src="https://i.ibb.co/23hMHTRt/logo-quantic-na-melhor-qualidade.png" class="q-quantic-logo"></div>'
        + '</div>';
